            ...
            <div class="col-md-6 col-sm-12 border mt-4 mx-2 p-4 rounded shadow">
                <div class="form">
                    ...
                    <form class="form-group" method="POST" action="">
                        ...
                        <br>
                        <textarea type="password" name="message" class="form-control" placeholder="Message"></textarea>
                        <br>
                        <br>
                        <button class="btn btn-primary btn-block" name="send">Send message</button>
                    </form>
                </div>
            </div>
            <div class="col-md-3 col-sm-12"></div>
