        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12 border mt-4 mx-2 p-4 rounded shadow">
                <div class="form">
                    ...
                    <form class="form-group" method="POST" action="user_registration.php">
                        ...
                        <br>
                        <input type="password" class="form-control" name="password_confirm" placeholder="Password confirm" id="password_confirm">
                        <br>
